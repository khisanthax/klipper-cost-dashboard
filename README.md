...
Klipper macros report job start/end data (time, filament)

Clients send that data to the Master dashboard

KCD stores raw + computed data (CSV + JSON)

Costs are calculated using your pricing profiles

The web UI lets you review, edit, group, and export jobs
